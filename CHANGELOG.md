...
- Configuration Files reference documentation covering all configuration files used in Wassette including config.toml, policy.yaml, component-registry.json, docker-compose.yml, and other build/toolchain configuration files with detailed schemas, examples, and best practices
