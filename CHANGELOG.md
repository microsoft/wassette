...
- Fixed Mermaid sequence diagram rendering in documentation by adding mdbook-mermaid preprocessor configuration ([#TBD](https://github.com/microsoft/wassette/pull/TBD))
