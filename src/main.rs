...
enum Commands {
    Serve {
        ...
        /// Disable built-in tools (load-component, unload-component)
        #[arg(long)]
...
async fn main() -> Result<()> {
    ...
    match &cli.command {
        Commands::Serve {
            ...
            let builtin_tools_enabled = !disable_builtin_tools;
            let server = McpServer::new(lifecycle_manager, builtin_tools_enabled);
