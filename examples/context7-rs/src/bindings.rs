        ...
        pub mod context7_rs {
            ...
            pub mod context7 {
                ...
                pub unsafe fn _export_resolve_library_id_cabi<T: Guest>(
                    ...
                    *ptr2.add(0).cast::<u8>() = (match success3 {
                    ...
                    let layout10 = _rt::alloc::Layout::from_size_align_unchecked(
                        vec10.len() * (8 + 8 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
                    ...
                    for (i, e) in vec10.into_iter().enumerate() {
                            ...
                            .add(i * (8 + 8 * ::core::mem::size_of::<*const u8>()));
                        {
                            ...
                            *base
                                ...
                                .cast::<i32>() = _rt::as_i32(code_snippets4);
                            *base
                                .add(4 + 6 * ::core::mem::size_of::<*const u8>())
                                .cast::<i32>() = _rt::as_i32(trust_score4);
                            let vec9 = versions4;
                            let len9 = vec9.len();
                    ...
                    *ptr2.add(2 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len10;
                    *ptr2.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = result10;
                    match error3 {
                        Some(e) => {
                            *ptr2
                                .add(3 * ::core::mem::size_of::<*const u8>())
                ...
                pub unsafe fn __post_return_resolve_library_id<T: Guest>(arg0: *mut u8) {
                    ...
                    _rt::cabi_dealloc(
                        base13,
                        len13 * (8 + 8 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
                    let l14 = i32::from(
                ...
                #[doc(hidden)]
                macro_rules! __export_microsoft_context7_rs_context7_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "microsoft:context7-rs/context7@0.1.0#resolve-library-id")]
                        unsafe extern "C" fn export_resolve_library_id(arg0 : * mut u8,
                        arg1 : usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_resolve_library_id_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name =
                        "cabi_post_microsoft:context7-rs/context7@0.1.0#resolve-library-id")]
                        unsafe extern "C" fn _post_return_resolve_library_id(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_resolve_library_id::<$ty > (arg0) } } #[unsafe
                        (export_name =
                        "microsoft:context7-rs/context7@0.1.0#get-library-docs")] unsafe
                        extern "C" fn export_get_library_docs(arg0 : * mut u8, arg1 :
                        ...
                        "cabi_post_microsoft:context7-rs/context7@0.1.0#get-library-docs")]
                        unsafe extern "C" fn _post_return_get_library_docs(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_get_library_docs::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_microsoft_context7_rs_context7_0_1_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_context7_rs_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::microsoft::context7_rs::context7::__export_microsoft_context7_rs_context7_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::microsoft::context7_rs::context7);
    };
}
#[doc(inline)]
pub(crate) use __export_context7_rs_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:microsoft:context7-rs@0.1.0:context7-rs:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6915] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x815\x01A\x02\x01A\x19\
...
\0\x12wasi:io/poll@0.2.1\x05\0\x02\x03\0\0\x08pollable\x01B\x0f\x02\x03\x02\x01\x01\
...
otonic-clock@0.2.1\x05\x02\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04se\
lf\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\0\x13wasi:io/error@\
0.2.1\x05\x03\x02\x03\0\x02\x05error\x01B(\x02\x03\x02\x01\x04\x04\0\x05error\x03\
...
2.1\x05\x05\x02\x03\0\x01\x08duration\x02\x03\0\x03\x0cinput-stream\x02\x03\0\x03\
...
pes@0.2.1\x05\x09\x02\x03\0\x04\x10outgoing-request\x02\x03\0\x04\x0frequest-opt\
...
\x0c\x04\0\x06handle\x01\x0d\x03\0\x20wasi:http/outgoing-handler@0.2.1\x05\x0e\x01\
...
\x06\x03\0\x1awasi:cli/environment@0.2.1\x05\x0f\x01B\x0e\x01ps\x01r\x06\x02ids\x04\
names\x0bdescriptions\x0dcode-snippetsy\x0btrust-scorey\x08versions\0\x04\0\x0el\
ibrary-result\x03\0\x01\x01p\x02\x01ks\x01r\x03\x07success\x7f\x07results\x03\x05\
error\x04\x04\0\x0fsearch-response\x03\0\x05\x01r\x03\x07success\x7f\x07content\x04\
\x05error\x04\x04\0\x0ddocs-response\x03\0\x07\x01@\x01\x0clibrary-names\0\x06\x04\
\0\x12resolve-library-id\x01\x09\x01ky\x01@\x03\x1econtext7-compatible-library-i\
ds\x05topic\x04\x06tokens\x0a\0\x08\x04\0\x10get-library-docs\x01\x0b\x04\0$micr\
osoft:context7-rs/context7@0.1.0\x05\x10\x04\0'microsoft:context7-rs/context7-rs\
@0.1.0\x04\0\x0b\x11\x01\0\x0bcontext7-rs\x03\0\0\0G\x09producers\x01\x0cprocess\
